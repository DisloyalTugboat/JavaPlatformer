...
function Coin(pos) {
  this.basePos = this.pos = pos.plus(new Vector(0, -0.75));
  this.size = new Vector(0.8, 1.5);
...
Spring.prototype.act = function(step, level)
{
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  if(type == "spring")
  {
  	this.player.speed.y = -jumpSpeed*2;
  }
